...
class SubmitViewController: UIViewController {
    ...
    func doSubmission() {
        ...
        let shoppingRecord = CKRecord(recordType: "Shopping")
        shoppingRecord["shopCategory"] = shopCategory as CKRecordValue
        shoppingRecord["shopInformation"] = shopInformation as CKRecordValue
